...
- `WHATSAPP_PHONE_NUMBER_ID=1153135121224452`, `WHATSAPP_VERIFY_TOKEN=<redacted-verify-token>`, `APP_SECRET` set. `WHATSAPP_APP_SECRET` NOT set (signature check off — fine for dev).
